...
class BounceTbl(models.Model):
    email_address = models.CharField(max_length=255)
    bounce_reason = models.CharField(max_length=255)
...
class SuppressedEmails(models.Model):
    ...
    lastupdatetime = models.TextField(db_column='LastUpdateTime', blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'suppressed_emails'
